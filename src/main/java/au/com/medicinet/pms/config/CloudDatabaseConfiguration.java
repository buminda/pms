package au.com.medicinet.pms.config;
...
@Configuration
@EnableMongoRepositories("au.com.medicinet.pms.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("au.com.medicinet.pms.config.dbmigrations");
